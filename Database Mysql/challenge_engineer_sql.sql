CREATE DATABASE  IF NOT EXISTS `challenge_engineer_sql` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `challenge_engineer_sql`;
-- MySQL dump 10.13  Distrib 8.0.41, for Win64 (x86_64)
--
-- Host: localhost    Database: challenge_engineer_sql
-- ------------------------------------------------------
...
CREATE TABLE `customer` (
  ...
  CONSTRAINT `customer_ibfk_1` FOREIGN KEY (`tipo_usuario_id`) REFERENCES `user_type` (`tipo_usuario_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `item` (
  ...
  CONSTRAINT `item_ibfk_1` FOREIGN KEY (`categoria_id`) REFERENCES `categoria` (`categoria_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `item_log` (
  ...
  `estado_atual` varchar(255) DEFAULT NULL,
  `data_hora` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `descricao` text,
  `usuario` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`log_id`),
  KEY `item_id` (`item_id`),
  CONSTRAINT `item_log_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `item` (`item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-03-30 11:11:04
